...
public class Provider {
     ...
     */
    public boolean send(Message message) throws NumberNotGivenException, NumberNotExistException {
        ...
        if (p == null) throw new NumberNotExistException();
     ...
     */
    public int getCreditForSmsHandy(String number) throws NumberNotGivenException, NumberNotExistException {
        if (number == null || number.isEmpty())
            throw new NumberNotGivenException();
        if(credits.get(number) == null) {
